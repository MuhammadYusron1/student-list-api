...
export default function Selection({active, onActiveChange, editActive, onEditActiveChange, stdID, student_ID, handleDelete, handleEdit, putName, setPutName, putStudentID, setPutStudentID, putAge, setPutAge, putSex, setPutSex, putAddress, setPutAddress, putSubject, setPutSubject}) {

	return (
		<div className={(editActive.editSelection || student_ID != stdID) ? // if edit selection is true or unique ID in different from current selected ID
										"z-50 invisible bg-white divide-y divide-gray-100 rounded shadow w-44 dark:bg-gray-700 dark:divide-gray-600 absolute top-[17px] right-auto bottom-auto left-[-156px]" : 
										"z-50 visible bg-white divide-y divide-gray-100 rounded shadow w-44 dark:bg-gray-700 dark:divide-gray-600 absolute top-[17px] right-auto bottom-auto left-[-156px]"}>
